 <h1 align="center"> Projeto (api Estacionamento) Front</h1>
<h5> Este projeto foi feito com o intuito de aprendizagem no terceiro perdiodo da faculdade para aprender a como conectar o front com o back </h5>
...
<img aling="center" alt="ts" src="https://shields.io/badge/TypeScript-3178C6?logo=TypeScript&logoColor=FFF&style=flat-square"> 

 <h2 align="center"> Telas </h2>
</div>

 ### A primeira tela de cadastro deve ser a marca, sem ela nao se pode cadastrar as outras 
...
### Entao deve se cadastrar o Modelo, tera uma opção de marcaspara escolher 
